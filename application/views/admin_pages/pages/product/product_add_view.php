...
<div class="col-md-12">
    ...
    <div class="box box-info" style="padding:0px 0px;">
        ...
        <form action="<?php echo base_url(); ?>Product/save_product" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="">
                            ...
                            <?php echo form_textarea(array('id' => 'txt_short_description', 'name' => 'txt_short_description', 'class' => 'textarea form-control', 'type' => 'text()', 'rows' => 5, 'cols' => 21,)); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="">
                            ...
                            <?php echo form_textarea(array('id' => 'txt_long_description', 'name' => 'txt_long_description', 'class' => 'textarea form-control', 'type' => 'text()', 'rows' => 7, 'cols' => 21,)); ?>
                        </div>
                    </div>
                </div>
