...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2016 at 01:52 PM
...
(1, 'Computer Accessories', 'upload_image/icons/category_icon/1.jpg', 0, '0000-00-00 00:00:00', 0, 0, 1, 0, NULL);
...
INSERT INTO `product` (`product_id`, `brand_id`, `category_id`, `product_name`, `product_short_des`, `product_long_des`, `meta_key`, `product_img`, `store_id`, `inserted_by`, `insert_time`, `updated_by`, `update_time`, `is_active`, `is_delete`) VALUES
(1, 1, 1, 'Dell 1265', '<div><ul><li>Checking the network cables, modem, and router</li><li>Reconnecting to Wi-Fi</li><li><a target="_blank" rel="nofollow">Running Windows Network Diagnostics</a></li></ul></div>\r\n\r\n<br>', '<p></p><ul><li>There is no Internet connection</li></ul><ul><li>Checking the network cables, modem, and router<br></li></ul><p></p><p></p><ul><li>Reconnecting to Wi-Fi</li><li><a target="_blank" rel="nofollow">Running Windows Network Diagnostics</a></li></ul><p></p>\r\n\r\n<br>', 10, 'upload_image/product_image/11.jpg', 0, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 1, 0);
